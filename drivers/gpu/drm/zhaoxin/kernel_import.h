...
/* bit ops */
    ...
    void  (*fence_back_trace_event)(int engine_index, unsigned long long fence);
    void  (*cmd_render_trace_event)(int engine_index, void *context, unsigned long long render_counter);
    void  (*dma_submit_trace_event)(int engine_index, void *context, unsigned long long render_counter, unsigned long long fence);
    ...
    struct zx_dma_addr_t* (*dma_map_page)(void *device, void *page, unsigned int offset, unsigned int size, unsigned int dir);
    void (*dma_unmap_page)(void *device, struct zx_dma_addr_t *addr, unsigned int size, unsigned int dir);
    void* (*get_page)(struct os_pages_memory *pages_memory, int page_num);
    unsigned int (*get_page_size)(struct os_pages_memory *memory);
    struct zx_dma_addr_t* (*get_page_dma_addr)(struct os_pages_memory *memory, int page_num);
    void (*set_page_dma_addr)(struct os_pages_memory *memory, int page_num, struct zx_dma_addr_t *dma_addr);
    int (*dma_mapping_error)(void *device, struct zx_dma_addr_t *dma_addr);
    unsigned long long (*fetch_iov_addr)(struct zx_dma_addr_t *zx_dma_addr);
